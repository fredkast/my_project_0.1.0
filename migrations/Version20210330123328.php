 ...
 */
final class Version20210330123328 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD nom VARCHAR(20) NOT NULL, ADD prenom VARCHAR(20) NOT NULL, ADD adresse VARCHAR(255) NOT NULL, ADD telephone VARCHAR(50) NOT NULL');
    }
